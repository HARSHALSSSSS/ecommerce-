...
async function seedAdmin() {
  try {
    ...
    const products = [
      ...
      { name: 'Polo Shirt Premium', description: 'Classic polo shirt for formal and casual occasions', price: 75.00, discount: 15, category: 'clothing', store_id: 1, image_url: 'https://m.media-amazon.com/images/I/71GYfbLFLpL._AC_UL1000_.jpg', sku: 'CLO-005' },
