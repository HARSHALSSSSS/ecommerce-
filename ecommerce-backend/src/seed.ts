...
async function seedAdmin() {
  try {
    ...
    const products = [
      ...
      { name: 'Polo Shirt Premium', description: 'Classic polo shirt for formal and casual occasions', price: 75.00, discount: 15, category: 'clothing', store_id: 1, image_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfvmuXZwEttsvfZ_t2TEp7lirXVUWFF_HDoA&s', sku: 'CLO-005' },
